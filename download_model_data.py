...
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://raw.githubusercontent.com/mediaProduct2017/blog_english/main/info_extract/extract_training2.json -d {DATA} -o alpaca_data_cleaned_archive.json")
