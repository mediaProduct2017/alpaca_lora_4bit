...
lora_path = '/data/proj_ja/alpaca_lora_4bit/alpaca_lora/checkpoint-200'  # 100
...
model, tokenizer = load_llama_model_4bit_low_ram(config_path, model_path, groupsize=128, device_map="auto")
# groupsize=-1
# device_map={'': 0}
...
model = PeftModel.from_pretrained(model, lora_path, torch_dtype=torch.float32, is_trainable=False, device_map=device_map)  # True
